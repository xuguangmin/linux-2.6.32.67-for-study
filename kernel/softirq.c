...
/*æ•°ç»„ä¸­æ¯ä¸€é¡¹,å¯¹åº”ä¸€ä¸ªè½¯ä»¶ä¸­æ–­å¤„ç†å‡½æ•°æŒ‡é’ˆ,åœ¨ä¸­æ–­å¤„ç†çš„SOFTIRQéƒ¨åˆ†,å¦‚æžœå‘çŽ°æœ¬åœ°CPUçš„_softirq_pendingä¸ŠTASKLET_SOFTIRQæˆ–è€…HI_SOFTIRQä½è¢«ç½®1,å°±å°†è°ƒç”¨tasklet_actionæˆ–è€…tasklet_hi_action*/
...
/*ç”¨æ¥åœ¨preempt_count()ä¸Šè¡¨ç¤ºSOFTIRQçš„ä¸Šä¸‹æ–‡,è€ƒè™‘åˆ°SOFTIRQæ‰§è¡Œè¿‡ç¨‹å¯èƒ½ä¼šè¢«å¤–éƒ¨ä¸­æ–­çš„æƒ…å†µ,è¿™å¯é˜²æ­¢SOFTIRQéƒ¨åˆ†çš„é‡å…¥,å› ä¸ºåªæœ‰åœ¨éžinterruptçš„ä¸Šä¸‹æ–‡ä¸­æ‰å¯ä»¥è¿›å…¥åˆ°SOFTIRQ*/
...
/*å‡½æ•°çš„æ ¸å¿ƒæ€æƒ³æ˜¯:ä»ŽCPUæœ¬åœ°çš„_softirq_pendingçš„æœ€ä½Žä½å¼€å§‹,ä¾æ¬¡å¾€é«˜ä½æ‰«æ,å¦‚æžœå‘çŽ°æŸä½ä¸º1,è¯´æ˜Žå¯¹åº”è¯¥ä½æœ‰ä¸ªç­‰å¾…ä¸­çš„softirqéœ€è¦å¤„ç†,é‚£ä¹ˆå°±è°ƒç”¨soft_vecæ•°ç»„ä¸­å¯¹åº”é¡¹çš„actionå‡½æ•°,è¿™ä¸ªè¿‡ç¨‹ä¼šä¸€ç›´æŒç»­ä¸‹åŽ»,çŸ¥é“__softirq_pendingä¸º0*/
 ...
 */
/*HARDIRQéƒ¨åˆ†çš„å¼€å§‹,å‘Šè¯‰ç³»ç»Ÿè¿›å…¥å†²æ–­å¤„ç†çš„ä¸ŠåŠéƒ¨åˆ†ï¼Œä¸Žirq_enterå¯¹åº”çš„æ˜¯irq_exit,irq_enterä¼šæ›´æ–°ç³»ç»Ÿä¸­çš„ä¸€äº›ç»Ÿè®¡é‡ï¼ŒåŒæ—¶ä¼šæŠŠå½“å‰æ ˆä¸­çš„preemtp_countå˜é‡åŠ ä¸ŠHARDIRQ_OFFSETæ¥æ ‡è¯†ä¸€ä¸ªHARDIRQä¸­ä¸Šä¸‹æ–‡*/
void irq_enter(void)
{
...
void irq_exit(void)
{
	account_system_vtime(current);
	trace_hardirq_exit();
	/*å‡½æ•°æŠŠå½“å‰æ ˆä¸­çš„preempt_countå˜é‡å‡åŽ»IRQ_EXIT_OFFSETæ¥æ ‡è¯†HARDIRQä¸­æ–­ä¸Šä¸‹æ–‡çš„ç»“æŸ,è¿™æ­¥åŠ¨ä½œå¯¹åº”do_IRQä¸­çš„irq_enter*/
	sub_preempt_count(IRQ_EXIT_OFFSET);
	/* invoke_softirqæ˜¯çœŸæ­£å¤„ç†SOFTIRQéƒ¨åˆ†çš„å‡½æ•°,è¿™ä¸ªå‡½æ•°çš„å‰ææ˜¯ifä¸­çš„
	 * ä¸¤ä¸ªæ¡ä»¶:in_interruptå’Œlocal_softirq_pending;invoke_softirqè¢«è°ƒç”¨çš„å‰ææ˜¯:å½“å‰ä¸åœ¨interruptä¸Šä¸‹æ–‡ä¸­è€Œä¸”__softirq_pendingä¸­æœ‰ç­‰å¾…çš„softirq.å½“å‰ä¸å†interruptä¿è¯äº†å¦‚æžœä»£ç æ­£åœ¨SOFTIRQéƒ¨åˆ†æ‰§è¡Œæ—¶,å¦‚æžœå‘ç”Ÿäº†ä¸€ä¸ªå¤–éƒ¨ä¸­æ–­,é‚£ä¹ˆåœ¨ä¸­æ–­å¤„ç†å‡½æ•°ç»“æŸHARDIRQéƒ¨åˆ†æ—¶,å°†ä¸ä¼šå¤„ç†softirq,è€Œæ˜¯ç›´æŽ¥è¿”å›ž,è¿™æ ·æ­¤å‰è¢«ä¸­æ–­çš„SOFTIRQéƒ¨åˆ†å°†ç»§ç»­æ‰§è¡Œ*/
...
struct tasklet_head
{
	...
	struct tasklet_struct **tail;	/*è¿™æ˜¯ä¸ªæŒ‡å‘taskletå¯¹è±¡æŒ‡é’ˆçš„æŒ‡é’ˆ,tailæ€»æ˜¯ä¿å­˜taskleté“¾è¡¨æœ€åŽä¸€ä¸ªèŠ‚ç‚¹æ‰€åœ¨taskletå¯¹è±¡ä¸­nextæˆå‘˜çš„åœ°å€*/
};
...
void __init softirq_init(void)
{
	...
	/*ç”¨æ¥åˆå§‹åŒ–ç®¡ç†taskleté“¾è¡¨çš„å˜é‡tasklet_vecå’Œtasklet_hi_vec*/
